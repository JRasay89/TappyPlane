...
public:
    void init(Graphics* graphics, Image* image, Input* input,OutlineFont* outlineFont, Background* background, Plane* plane, Ground* ground, RockManager* rockManager, PlayerScore* score);
